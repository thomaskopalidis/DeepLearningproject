# -*- coding: utf-8 -*-
"""House_price_Transformers.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1bNRt9YpveUwtI7-m18-75so6hfV6GWv5
...
sns.distplot(data['SalePrice']) # to see the price as gausian plot
...
housing.isnull().sum() # we have to diminsish the nulls
...
#PREPROCESSING
convert the dataframe into 2 dataframes (categorical and numerical)

1st find and categorize the categorical and the numeric type
"""
...
"""i have to convert the catrgory
